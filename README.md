...
*In progress. The pipeline is being validated in three tiers:
internal precision (ray-intersection error, bundle-adjustment residuals);
pipeline accuracy — the identical chain run on ESP_012579_1420 +
ESP_012434_1420 (Harmakhis Vallis), the pair behind the official
USGS-produced
[DTEEC_012579_1420_012434_1420_U01](https://www.uahirise.org/dtm/dtm.php?ID=ESP_012579_1420),
with elevation-difference and slope-statistics comparison; and a
scene-specific long-wavelength check of the juncture DTM against the
independent HRSC h2609 DTM strip. Numbers and figures land here.*
